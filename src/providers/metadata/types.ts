...
export interface AnimeMetadataProvider {
  ...
  browse(params: { sort?: string; status?: string; genre?: string; seasonYear?: number; season?: string; format?: string; yearFrom?: number; yearTo?: number; perPage?: number; page?: number }, signal?: AbortSignal): Promise<{ data: Anime[]; hasNextPage: boolean; pageInfo: { currentPage: number; lastPage?: number } }>
}
